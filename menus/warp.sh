...
function setup_warp_cron {
    while true; do
        ...
        echo -e "${BLUE}----------------------------------------------------------${NC}"
        ui_item "1" "🌙" "Каждую ночь"     "В 03:00"
        ui_item "2" "📅" "Раз в неделю"    "В ночь на воскресенье"
        ui_item "3" "⏳" "Каждые 12 часов" "В 00:00 и 12:00"
        ui_item "4" "🚫" "Отключить"       "Снять автоперезапуск совсем"

...
drive menu_utils.sh 'X\n4\n\nX\nX\n'   'Активные порты'  'утилиты: порты (клавиша 4)'
drive menu_utils.sh 'X\n5\n\nX\nX\n'   'Внешний IP'      'утилиты: внешний адрес (клавиша 5)'
drive menu_xui.sh   'X\n3\nX\nX\nX\n'  'УЧЁТНЫЕ ДАННЫЕ'  'X-UI: учётные данные (клавиша 3)'
drive menu_awg.sh   'X\n2\nX\nX\n'     'ВЫДАННЫЕ КЛИЕНТЫ' 'AWG: клиенты (клавиша 2)'
drive menu_awg.sh   'X\n4\n\nX\nX\n'   'iface|awg0|config-applied' 'AWG: журнал (клавиша 4)'
drive menu_telemt.sh 'X\n6\n\nX\nX\n'  'УЧЁТНЫЕ ДАННЫЕ'  'telemt: учётные данные (клавиша 6)'

...
| `/etc/vsm/telemt.conf` | Домены, порты, MTProto-секрет, логин и пароль telemt_panel | 600 |
...
|---|---|---|
| 443 | Панель 3x-ui и её сайт | Извне |
| 8444 | telemt (MTProto) | Извне |
| 9444 | telemt_panel | Извне |
...
| 4 | Восстановить маскировку | Пересоздаёт vhost nginx из сохранённых настроек — после патча панели |

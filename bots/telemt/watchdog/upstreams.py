...
писателей осталось выше порога.

ОТВЕТ НА ЭТОТ ВОПРОС НАЙДЕН 08.09.2026, см. dcs.py. Покрытие писателей —
среднее по серверу, и оно не должно было просесть: пустая группа из
двенадцати двигает его слишком слабо, чтобы перейти порог. Замер живой
аварии: покрытие 77% при пороге 50, а DC 5 и -5 пусты полностью, и так
сутки. Теперь пустую группу ловит отдельная тревога, а этот сигнал
по-прежнему про другое — про жёсткие отказы исходящих подключений.

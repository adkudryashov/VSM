...
async def get_all_servers_status_parts():
    ...
    # Панелей может не быть ни одной.
    #
    # Шапка таблицы печаталась безусловно, и на установке без панелей 3x-ui
    # сводка показывала пять заголовков столбцов и пустоту под ними. Раздел,
    # который ничего не сообщает, хуже отсутствующего: он выглядит как поломка
    # сбора данных, и человек идёт искать её там, где ничего не сломано.
    # Увидено владельцем на первой живой сводке 27.08.2026.
    if not sorted_results:
        return ("<i>Панели 3x-ui не заведены — добавить можно в разделе «3x-ui».</i>",
                "Панели 3x-ui не заведены — добавить можно в разделе «3x-ui».")
